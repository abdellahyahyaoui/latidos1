...
//           <div key={index} className="parrafo-relato" dangerouslySetInnerHTML={{ __html: procesarTexto(parrafo) }} />
//         ))}

//         {/* ✅ MOVER: Reproductor de audio integrado en el contenido */}
//         {sectionTitle === "¡Jatofin! " && autor === "Abdellah Yahyaoui Azuz" && (
//   <AudioPlayer
//     title="Road to gaza por Adam y.c"
//     src="/audio/Voice-to-gaza.mp3"
//   />
// )}
...
//   <AudioPlayer
//     title="Oh Diyaa… Intro por Abdulrazzaq"
//     src="/audio/abdulrazzaq.mp3"
//   />
// )}
